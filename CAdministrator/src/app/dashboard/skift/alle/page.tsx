...
import { Search, Clock, User, Car } from 'lucide-react'
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="text-center py-8">Laster alle skifter...</div>
      </div>
    )
  }
      ...
      <div className="max-w-full mx-auto px-6 sm:px-8 lg:px-12 py-8">
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>
                Alle skift ({filteredSkifts.length} av {skifts.length})
